...
builder.Services.AddScoped(typeof(IRepositor<>), typeof(Repository<>));
...
builder.Services.AddApplicationService(builder.Configuration); //kendi yazdýklarýmýz daha temiz burasý
